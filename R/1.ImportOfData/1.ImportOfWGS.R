...
AbiEnza.Metadata <- readxl::read_xlsx('~/git/ResponsePredictionAbiEnza/Misc/Suppl. Table 1 - OverviewOfData.xlsx', sheet = 'Sample overview')
...
# All samples.
R2CPCT::performGISTIC2(AbiEnza.CohortWGS$copyNumbers, outputFolder = '/mnt/onco0002/repository/HMF/DR71/Oct2021/results/GISTIC2/AbiEnza/AllSamples/')

# Good responders.
R2CPCT::performGISTIC2(AbiEnza.CohortWGS$copyNumbers[GenomicRanges::mcols(AbiEnza.CohortWGS$copyNumbers)$sample %in% (AbiEnza.Metadata %>% dplyr::filter(grepl('Good Responder', Responder)) %>% dplyr::pull(sampleId)),], outputFolder = '/mnt/onco0002/repository/HMF/DR71/Oct2021/results/GISTIC2/AbiEnza/GoodResponders/')

# Poor responders.
R2CPCT::performGISTIC2(AbiEnza.CohortWGS$copyNumbers[GenomicRanges::mcols(AbiEnza.CohortWGS$copyNumbers)$sample %in% (AbiEnza.Metadata %>% dplyr::filter(grepl('Bad Responder', Responder)) %>% dplyr::pull(sampleId)),], outputFolder = '/mnt/onco0002/repository/HMF/DR71/Oct2021/results/GISTIC2/AbiEnza/BadResponders/')

# Example of the GISTIC2 command used:
# GISTIC2_2.0.23/gistic2 -b /mnt/onco0002/repository/HMF/DR71/Oct2021/results/GISTIC2/BadResponders/ -seg /tmp/Rtmp7hzfek/50de7e5bd09e.txt -refgene GISTIC2_2.0.23/refgenefiles/hg19.UCSC.add_miR.140312.refgene.mat -genegistic 1 -gcm extreme -maxseg 4000 -broad 1 -brlen 0.98 -conf 0.95 -rx 0 -cap 3 -saveseg 0 -armpeel 1 -smallmem 0 -res 0.01 -ta 0.3 -td 0.3 -savedata 0 -savegene 1 -qvt 0.1 -twoside 0
...
AbiEnza.Results$GISTIC2.AllSamples <- R2CPCT::importGISTIC2('/mnt/onco0002/repository/HMF/DR71/Oct2021/results/GISTIC2/AbiEnza/AllSamples/')
AbiEnza.Results$GISTIC2.GoodResponders <- R2CPCT::importGISTIC2('/mnt/onco0002/repository/HMF/DR71/Oct2021/results/GISTIC2/AbiEnza/GoodResponders/')
AbiEnza.Results$GISTIC2.BadResponders <- R2CPCT::importGISTIC2('/mnt/onco0002/repository/HMF/DR71/Oct2021/results/GISTIC2/AbiEnza/BadResponders/')
